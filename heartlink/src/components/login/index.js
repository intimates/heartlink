// FIXME: just imported from previous version

require('insert-css')(require('./style.css'))

// FIXME: duplicate code
function pn_value_to_rgba(pn_value) {
  var pn_color;
...
module.exports = {
  ...
  ready: function() {
    ...
    $("div[id^='dummy_message']").each(function(){
      ...
      pn_color = pn_value_to_rgba(pn_value);
        ...
        $("div#login_face").animate({
          ...
          complete: function(){
            ...
            $("img#stamp").css({
              ...
              duration: 300, easing: "easeOutBack",
              complete: function(){
                setTimeout(function() { parent.changeView('messages') }, 300);
              }
            });
          }
        });
